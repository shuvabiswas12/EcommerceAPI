...
namespace EcommerceAPI.Data.Migrations
{
    ...
    [Migration("20240727183850_added_wishlist_table")]
    partial class added_wishlist_table
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ShoppingBasketAPI.Domain.Discount", b =>
                {
            ...
            modelBuilder.Entity("ShoppingBasketAPI.Domain.FeaturedProduct", b =>
                {
                    b.Property<string>("ProductId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("ShoppingBasketAPI.Domain.OrderDetail", b =>
                {
                    b.Property<string>("ProductId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("ShoppingBasketAPI.Domain.OrderHeader", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("ShoppingBasketAPI.Domain.ProductAvailability", b =>
                {
                    b.Property<string>("ProductId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("ShoppingBasketAPI.Domain.Wishlist", b =>
                {
                    b.Property<string>("ProductId")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("ShoppingBasketAPI.Domain.Discount", b =>
                {
                    b.HasOne("ShoppingBasketAPI.Domain.Product", "Product")
                        .WithOne("Discount")
                        .HasForeignKey("ShoppingBasketAPI.Domain.Discount", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ShoppingBasketAPI.Domain.FeaturedProduct", b =>
                {
                    b.HasOne("ShoppingBasketAPI.Domain.Product", "Product")
                        ...
                        .HasForeignKey("ShoppingBasketAPI.Domain.FeaturedProduct", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ShoppingBasketAPI.Domain.OrderDetail", b =>
                {
                    b.HasOne("ShoppingBasketAPI.Domain.OrderHeader", "OrderHeader")
            ...
            modelBuilder.Entity("ShoppingBasketAPI.Domain.ProductAvailability", b =>
                {
                    b.HasOne("ShoppingBasketAPI.Domain.Product", "Product")
                        ...
                        .HasForeignKey("ShoppingBasketAPI.Domain.ProductAvailability", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ShoppingBasketAPI.Domain.Wishlist", b =>
                {
                    ...
                    b.HasOne("ShoppingBasketAPI.Domain.Product", "Product")
                        .WithOne("Wishlist")
                        .HasForeignKey("ShoppingBasketAPI.Domain.Wishlist", "ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
